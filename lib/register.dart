...
class _registorState extends State<registor> with InputValidationMixin{
  ...
  Profile_model profile = Profile_model(username: "", email: "", number: "", password: "", name:"");
                                                ...
                                                child: TextField(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if(pickedDate != null ){
                                                      ...
                                                      print("Date is not selected yet.");
                                                    }
                                                  },
                                                ),
                                              ),
                                            ...
                                            onPressed: () async {
                                              if(txtName == "" || txtLastName.text =="" || txtDateOfBirth.text =="" || selectedGender == "" || txtPhoneNumber.text == "" || txtEmail.text == "" || txtPassword == "" || txtAddress.text == "") {
                                                EasyLoading.showError(
                                                 ...
                                                 EasyLoading.showError(
                                                  "Password should follow a minimum 6 characters which contain a-z, A-z and 0-9",);
                                              }
                                              else {
                                                if(!isEmailValid(txtEmail.text)){
                                                  EasyLoading.showError(
                                                    "The email is wrong pattern.",);
                                                }
                                                //new add (try to create exists email)
                                                // else if(txtEmail.text == AppUrl.Email){
                                                //   AppUrl.Email = email;
                                                //   DatabaseReference mailRef = _db.once();
                                                //   .child('Users');
                                                //    await mailRef.child(email).set({
...
//   }else{
//     print("Email is already exist in database.");
//   }
//   return snapshot !=null;
// }
//   print("exists?");
//   rootFirebaseIsExists(FirebaseDatabase.instance.reference().child("Users").child('email'));
